...
export default function AdminGazettePage() {
  ...
  async function uploadPdf(file: File, title: string, year: string) {
    const isPdf =
    ...
    try {
      ...
      if (selectedFile) {
        const uploaded = await uploadPdf(
          selectedFile,
          form.title.trim(),
          String(getYearFromPeriodDate(form.periodDate) || new Date().getFullYear())
        );
  ...
  if (!profile) {
    return <AccessCard title="Connexion requise" text="Connecte-toi avec un compte admin." />;
  }

  if (!isAdmin) {
    return <AccessCard title="Accès refusé" text="Cette page est réservée aux admins." />;
  }
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-6 text-[#D8C7A0]">
                Ajoute les gazettes mensuelles en PDF, publie-les ou archive-les.
              </p>
            </div>
          ...
          <section className="rounded-[28px] border border-[#D9A441]/25 bg-[#160A12]/90 p-6 shadow-2xl shadow-black/40">
            ...
            <form onSubmit={handleSubmit} className="mt-6 grid gap-5">
              <FormInput
                ...
                placeholder="Ex : Gazette GF - Juin 2026"
              />
              ...
              <label>
                ...
                <textarea
                  ...
                  className="min-h-28 w-full rounded-xl border border-[#D9A441]/20 bg-[#0B0610] px-4 py-3 text-[#F7E9C5] outline-none transition placeholder:text-[#8F7B5C] focus:border-[#D9A441]/60"
                  placeholder="Petit résumé de la gazette..."
                />
              </label>
              ...
              <label>
                ...
                <p className="mt-2 text-xs text-[#8F7B5C]">
                  Format affiché : jj/mm/aa, exemple 06/02/26.
                </p>
              </label>
              ...
              <label>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#D9A441]/20 bg-[#0B0610] px-4 py-3 text-[#F7E9C5] file:mr-4 file:rounded-lg file:border-0 file:bg-[#F2C300] file:px-4 file:py-2 file:text-sm file:font-black file:text-black"
                />

                {editingGazette && (
                  <p className="mt-2 text-xs text-[#8F7B5C]">
                    Laisse vide pour conserver le PDF actuel.
                  </p>
                )}
              </label>
                        ...
                        >
                          <td className="px-4 py-4">
                            ...
                            <p className="mt-1 text-xs text-[#8F7B5C]">
                              Publié : {formatDate(gazette.published_at)}
                            </p>
                          </td>
